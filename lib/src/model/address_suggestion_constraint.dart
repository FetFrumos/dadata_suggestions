...
class AddressSuggestionConstraint {
  ...
  AddressSuggestionConstraint({
    ...
    required this.city,
    required this.streetTypeFull,
    required this.settlementTypeFull,
    required this.cityDistrictTypeFull,
    required this.cityTypeFull,
    required this.areaTypeFull,
    required this.regionTypeFull,
    required this.country,
    required this.countryISOCode,
    required this.regionISOCode,
    required this.kladrId,
    required this.regionFIASId,
    required this.areaFIASId,
    required this.cityFIASId,
    required this.settlementFIASId,
    required this.streetFIASId,
  });
